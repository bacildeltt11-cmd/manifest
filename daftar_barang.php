...
foreach ($docs as $d) {
    $arr = (array)$d;
    if (!empty($arr['nama'])) $barang_list[] = $arr['nama'];
}

// Jika kosong, pakai default (sama seperti api)
if (empty($barang_list)) {
    $barang_list = ["Alpukat","Apel","Bawang Putih","Bawang Goreng","Bombay","Brambang","Cabe","Emping","Garam","Gula","Jipan","Kacang Hijau","Kacang Tanah","Kemiri","Kentang","Kertas","Ketan","Kol","Krupuk","Kunir","Mangga","Plastik","Rempah","Salak","Sawi","Telur","Tomat","Terong","Wortel","Trasi","Kurma","Keluak","Kacang kupas"];
}
?>
<!DOCTYPE html>
<html lang="id">
